    ...
    <div class="sidebar-content">
                ...
                <div class="media">
                    <div class="mr-3">
                        <a href="{{ route('my_account') }}">
                            ...
                            {{-- <img src="/storage/uploads/super_admin/9OGZZCVPLB/photo.png" width="38" height="38" class="rounded-circle" alt="photo"> --}}
                        </a>
                    </div>
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                {{--SMS--}}
                @if(Qs::userIsAdministrative())
                    <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['sms.index', 'sms.create', 'sms.edit',  'sms.show',]) ? 'nav-item-expanded nav-item-open' : '' }} ">
                        <a href="#" class="nav-link"><i class="icon-office"></i> <span> SMS</span></a>

                        <ul class="nav nav-group-sub" data-submenu-title="Administrative">

                            {{--Payments--}}
                            @if(Qs::userIsTeamAccount())
                            <li class="nav-item nav-item-submenu {{ in_array(Route::currentRouteName(), ['sms.index', 'sms.create', 'sms.edit',  'sms.show']) ? 'nav-item-expanded' : '' }}">

                                <a href="#" class="nav-link {{ in_array(Route::currentRouteName(), ['sms.index', 'sms.edit', 'sms.create',  'sms.show']) ? 'active' : '' }}">SMS</a>

                                <ul class="nav nav-group-sub">
                                    <li class="nav-item"><a href="{{ route('sms.create') }}" class="nav-link {{ Route::is('sms.create') ? 'active' : '' }}">Send single sms</a></li>
                                    <li class="nav-item"><a href="{{ route('sms.index') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['sms.index', 'sms.edit', 'sms.show']) ? 'active' : '' }}">Manage SMS</a></li>
                                    {{-- <li class="nav-item"><a href="{{ route('payments.manage') }}" class="nav-link {{ in_array(Route::currentRouteName(), ['payments.manage', 'payments.invoice', 'payments.receipts']) ? 'active' : '' }}">Student Payments</a></li> --}}
