        ...
        <form method="post" action="{{ route('marks.tabulation_select') }}">
                    ...
                    <div class="row">
                                    ...
                                    {{-- <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="my_class_id" class="col-form-label font-weight-bold">Class:</label>
                                            <select onchange="getClassSections(this.value)" required id="my_class_id" name="class_type_id" class="form-control select" data-placeholder="Select Class">
                                                <option value=""></option>
                                                @foreach($my_classes as $c)
                                                    <option {{ ($selected && $class_type_id == $c->class_type_id) ? 'selected' : '' }} value="{{ $c->class_type_id }}">{{ $c->names }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div> --}}
