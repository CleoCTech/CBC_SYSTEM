...
use App\Http\Controllers\SupportTeam\SMSController;
    ...
    Route::group(['namespace' => 'SupportTeam',], function(){
        ...
        Route::group(['prefix' => 'marks'], function(){
           ...
           // FOR teamSA
            ...
            Route::post('/marks/update-setup', [MarkController::class, 'updateSetup'])->name('marks.updateSetup');
        ...
        // Route::resource('single-sms', [SMSController::class]);
        Route::resource('sms', 'SMSController');

        Route::post('/students/import', [StudentRecordController::class, 'importCsv'])->name('students.import');
